...
const Navbar: React.FC<NavbarProps> = ({ 
  ...
  const isCurrentViewInUploads = currentView === AppView.UPLOAD || currentView === AppView.BANK_STATEMENT || currentView === AppView.EXCEL_IMPORT;
        ...
        <div className="flex items-center gap-3 min-w-fit">
             ...
             <div className="flex items-center gap-1">
                 ...
                 <button
                    onClick={onLock}
                    title="Lock App"
                    className="p-2 rounded-lg hover:bg-red-900/50 text-slate-400 hover:text-red-400 transition-colors ml-2 border-l border-slate-700 pl-3"
                 >
